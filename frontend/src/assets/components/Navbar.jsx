...
export default function Navbar() {
  ...
  return (
    <>
      <div className={`navbar max-w-screen-xl container mx-auto md:px-10 px-2 fixed top-0 right-0 left-0 z-50 dark:bg-slate-800 dark:text-white
         ${sticky?"sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out":""}`}>
        <div className="navbar-start dark:bg-slate-800">
          ...
          <a className="text-xl md:text-2xl font-bold cursor-pointer">Game Store</a>
        </div>
        <div className="navbar-end space-x-3">
          <div className="navbar-center hidden lg:flex dark:bg-slate-800 dark:text-white">
